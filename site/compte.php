...
<?php
    if (isset($_SESSION["pseudo"])){
        //si l'utilisateur essaie d'entrée dans l'espace compte sans ce connecter par un lien
        try{
            ...
            <?php
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                      ...
                      if ( $nomVal || $prenomVal || $ageVal || $pseudoVal || $mdpVal || $mdp1Val || $mdp2Val){
                          try{
                             $pdo_options[PDO::ATTR_ERRMODE] = PDO::ERRMODE_EXCEPTION;
                             $cdd = new PDO('mysql:host=localhost;dbname=id1227213_mydb', 'id1227213_abc', '', $pdo_options);
